...
if ($redLight === true || $yellowLight  === true){
    echo "<p>Stop the car!</p>";
}elseif($redLight === false && $yellowLight === false){
...
*/
switch ($redLight){
        case $redLight === true || $yellowLight === true;
    echo "<p>Stop the car!</p>";
        break;
    case $redLight === false && $yellowLight === false;
    echo "<p>Keep moving!</p>";
    break;
    case $redLight === true || $yellowLight === true && $greenLight === true;
    echo "<p>Traffic lights are messed up!</p>";
    break;
    default: "<p>Use the common sense and stay safe!</p>";
}
